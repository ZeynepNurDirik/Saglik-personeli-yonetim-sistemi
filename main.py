...
def create_dataframe():
    try:
        ...
        doktor1 = Doktor(100, "Sena", "Tekin", "Göz", 85000, "Göz Hastalıkları", 6, "Medicana")
        doktor2 = Doktor(101, "Gülnur", "Görür", "Diş", 83000, "Ortodonti", 3, "Acıbadem")
        doktor3 = Doktor(102, "Gülsu", "Güzelcan", "Fizyoterapi", 80000, "Duruş Bozuklukları", 2, "Medical Point")

        hemsire1 = Hemsire(200, "Aslı", "Kaya", "Acil", 35000, 40, "Sertifika A", "Acıbadem")
        hemsire2 = Hemsire(201, "Raziye", "Aydın", "Acil", 43000, 36, "Sertifika C", "Medical Point")
        hemsire3 = Hemsire(202, "Emine", "Tekin", "Acil", 40000, 35, "Sertifika C", "Medicana")

        hasta1 = Hasta(300, "Damla", "Çelik", "12.03.2003", "Grip", "Serum")
        hasta2 = Hasta(301, "Sude", "Yılmaz", "08.01.1998", "Yüksek Şeker", "İlaç Tedavisi")
        hasta3 = Hasta(302, "Elif", "Demir", "17.10.2010", "Göz Kuruluğu", "İlaç Tedavisi")
        hasta4 = Hasta(303, "Hasan", "Dirik", "26.06.1977", "Boyun Ağrısı", "Egzersiz")
        hasta5 = Hasta(304, "Zeynep", "Dirik", "06.06.2005", "Grip", "İlaç Tedavisi")

        # Verilerin hepsinin aynı uzunlukta olduğundan emin olmak için personel ve hasta sayısını ayarlayın
        data = {
            "Personel No": [
                personel1.get_personel_no(), personel2.get_personel_no(), personel3.get_personel_no(),
            ...
            "Ad": [
                personel1.get_ad(), personel2.get_ad(), personel3.get_ad(),
            ...
            "Soyad": [
                personel1.get_soyad(), personel2.get_soyad(), personel3.get_soyad(),
            ...
            "Departman": [
                personel1.get_departman(), personel2.get_departman(), personel3.get_departman(),
            ...
            "Maas": [
                personel1.get_maas(), personel2.get_maas(), personel3.get_maas(),
